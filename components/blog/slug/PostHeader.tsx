    ...
    <div className="">
      ...
      <div className="hidden md:flex items-center justify-between mx-2 md:mx-10 md:-mt-16 relative">
        <div className="space-x-6 flex items-center">
          <div className="w-32 border-4 border-gray-100 rounded-full">
            <ImageBlur
              width={100}
              height={100}
          ...
          <h2 className="bg-gray-100 py-2 px-4">{post.author.name}</h2>
        </div>
        <p className="bg-gray-100 py-2 px-4 text-xl text-gray-600"><Date dateString={post.date} /></p>
      </div>
      <div className="flex md:hidden items-center space-x-4 pt-8">
        ...
        <div>
          <h2 className="bg-gray-100 py-2">{post.author.name}</h2>
          <p className="bg-gray-100 py-2 text-xl text-gray-600"><Date dateString={post.date} /></p>
        </div>
      </div>
